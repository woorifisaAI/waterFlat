...
public class User {
    ...
    public void likeChange(Integer receivedLikeCnt) {
        ...
        if (this.receivedLikeCnt >= 1000 && this.userRole.equals(UserRole.SILVER)) {
    ...
    public void changeRole() {
        if (userRole.equals(UserRole.USER)) userRole = UserRole.SILVER;
        ...
        else if (userRole.equals(UserRole.BLACKLIST)) userRole = UserRole.USER;
    }
}
