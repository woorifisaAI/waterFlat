package com.waterflat.board.config;

import com.waterflat.board.config.auth.MyAccessDeniedHandler;
import com.waterflat.board.config.auth.MyAuthenticationEntryPoint;
import com.waterflat.board.config.auth.MyLoginSuccessHandler;
import com.waterflat.board.config.auth.MyLogoutSuccessHandler;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .antMatchers("/boards/greeting/write").hasAnyAuthority("USER", "ADMIN")
                .antMatchers(HttpMethod.POST, "/boards/greeting").hasAnyAuthority("USER", "ADMIN")
